...
@Injectable()
class Modal {
    Modal(DynamicComponentLoader componentLoader, ApplicationRef appRef,
     ...
     */
    //Todo: FunctionConstructor?
    Future<ComponentRef> open(FunctionConstructor componentType, List<ResolvedProvider> bindings,
        {ModalConfig config})  {
     ...
     * @returns {Promise<ModalDialogInstance>}
     */
    Future<ComponentRef> openInside(FunctionConstructor componentType, ElementRef elementRef,
